...
import ch.zli.m223.service.MonitorAusleiheService;
import javax.ws.rs.PathParam;
import javax.ws.rs.PUT;

@Path("/monitorAusleihe")
@Tag(name = "Entries", description = "Handling of MonitorAusleiheen")
public class MonitorAusleiheController {

    @Inject
    MonitorAusleiheService MonitorAusleiheService;
